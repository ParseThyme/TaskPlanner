...
import com.example.myapplication.data_classes.TaskGroupRow
...
class SaveLoad(context: Context) {
    ...
    // Save
    // ####################
    fun saveTaskGroupList(savedList: ArrayList<TaskGroupRow>) {
